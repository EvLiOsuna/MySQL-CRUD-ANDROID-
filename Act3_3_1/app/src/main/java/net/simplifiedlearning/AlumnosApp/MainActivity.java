...
import net.simplifiedlearning.myheroapp.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    class HeroAdapter extends ArrayAdapter<AlumnoClass> {
        List<AlumnoClass> alumnoClassList;

        public HeroAdapter(List<AlumnoClass> alumnoClassList) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final AlumnoClass alumnoClass = alumnoClassList.get(position);
